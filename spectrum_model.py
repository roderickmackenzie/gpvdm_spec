...
def earth_calc(Latitude, Longitude, W, p, Date, Time, AOD, timezone):
    ...
    file_location = os.path.join(os.getcwd(), 'external_data', 'spctral2 data.xlsx')
    ...
    #Luminosity
    file_location = os.path.join(os.getcwd(), 'external_data', 'luminosityFunction.xlsx')
...
def mars_calc(orbitalpoint,AOD):
    ...
    #CO2 absorption
    file_location = os.path.join(os.getcwd(), 'external_data', 'co2 data.xlsx')
